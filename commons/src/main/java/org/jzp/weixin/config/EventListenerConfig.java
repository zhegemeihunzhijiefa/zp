package org.jzp.weixin.config;


import java.util.ArrayList;
import java.util.List;

import org.jzp.weixin.domain.InMessage;
import org.jzp.weixin.domain.ResponseToken;
import org.jzp.weixin.domain.event.EventInMessage;
import org.jzp.weixin.service.JsonRedisSerializer;
...
public interface EventListenerConfig extends//
	...
	public default RedisMessageListenerContainer messageListenerContainer(//
		...
		// 监听具体某个通道
		topics.add(new ChannelTopic("jzp_event"));
