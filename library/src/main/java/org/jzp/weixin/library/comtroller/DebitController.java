package org.jzp.weixin.library.comtroller;


import org.jzp.weixin.library.domain.DebitList;
import org.jzp.weixin.library.service.LibraryService;
...
@Controller
@RequestMapping("/jzp/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/jzp/library/debit/list";
	}
